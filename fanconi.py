...
for cond in CONDITIONS:
    ...
    if ASYNCH:
        n_iterations = 50
        n_runs = 100
        run_FA_Boolean_asynch(model_text, n_iterations, n_runs, species_to_plot, verbose=False,
    ...
    if PYSB:
        ...
        for n in range(n_iter):
            ...
            t_thresh = run_FA_Boolean_pysb(model_pysb, t_end, n_runs, species_to_plot, param_values=pvals,
